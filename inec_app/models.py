...
class PollingUnit(models.Model):
    ...
    latitude = models.CharField(max_length=255, blank=True, null=True, db_column='lat')
    longitude = models.CharField(max_length=255, blank=True, null=True, db_column='long')
    ...
    def get_absolute_url ( self ):
        return reverse('question1_result', kwargs = { 'uniqueid' : self.uniqueid }) 
